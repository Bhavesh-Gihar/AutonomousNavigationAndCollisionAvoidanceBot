...
if __name__ == "__main__":
        ...
        bag_file = '/home/bhavesh/Documents/AutonomousNavigationAndCollisionAvoidanceBot/bag_files/circleMaze2.0/circleMaze2.0_0.db3'
        ...
        # csv_file_path = "circleMaze2.0.csv"
        ...
        with open('example.txt', 'a') as file:
            file.write('float inp[1000][360] = {')
            for i in range(1000):
                file.write('{' + str(actualScan[i][1].ranges[0]))
                for j in range(1, 360):
                    file.write(', ' + str(actualScan[i][1].ranges[j]))
                file.write('}, ')
            file.write('};')
